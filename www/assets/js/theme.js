...
//     // if(url_array[url_array.length - 1] != "register.html" || url_array[url_array.length - 1] != "register_union.html"){
...
(function($) {
  ...
  var theme = {
    ...
    */
    onepageNavLinks: () => {
      var empty_a = $('.onepage .navbar ul.navbar-nav a[href="javascript:void(0)"]');
    ...
    */
    anchorSmoothScroll: () => {
      $(function() {
        ...
        $('a.scroll[href*="#"]:not([href="javascript:void(0)"])').on('click', function() {
