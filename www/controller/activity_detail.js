      ...
      if (data.status == "SUCCESS") {
        ...
        for (let i = 0; i < data.data["dactivity"].length; i++) {
          ...
          list_activity.innerHTML +=
            ...
            sub_activity_id +
            '"  onclick="detailactivity(this)" ><h6 class="card-header text-ilo-dark-blue pb-0 ps-4 pe-4" style="border:none !important; border-radius: 0 !important;">' +
            "<b><b>" +
            ...
            "<small>" +
            '<b>Start Date : <span class="text-primary">' +
            start +
            "</span></b>" +
            "</small>" +
            "</p>" +
            ...
            '<p class="card-text text-dark">' +
            "<small>" +
            '<b>Due Date : <span class="text-danger">' +
            due +
            "</span></b>" +
            "</small>" +
            "</p>" +
            ...
            sub_activity_id +
            '" onclick="detailactivity(this)" class="btn btn-ilo-dark-blue w-100 mt-5">View Detail</button>' +
            "</div>" +
            "</div>" +
            "</div>" +
            "</div>" +
