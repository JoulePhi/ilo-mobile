...
$(document).ready(function () {
    ...
    if (url_array2[url_array2.length - 1] == "activities.html" || url_array2[url_array2.length - 1] == "detail_activity.html" || url_array2[url_array2.length - 1] == "activity_report_detail.html" || url_array2[url_array2.length - 1] == "change_password.html") {
...
function changeDateFormat(dateString) {
    ...
    var options = { day: 'numeric', month: 'long', year: 'numeric', hour: 'numeric', minute: 'numeric', hour12: false };
