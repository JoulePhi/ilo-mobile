$(document).ready(function () {
  ...
  cachedAjax({
    ...
    success: function (data) {
      $("#usersAvatar").attr(
        "src",
        base_url_endpoint + "assets/images/avatars/" + data.photo
      );
      $("#name").val(data.name);
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data.status == "success") {
          $("#usersAvatar").attr(
            "src",
            base_url_endpoint + "assets/images/avatars/" + data.data.photo
          );
          $("#avatar").val("");
...
function isImageFile(fileName) {
  return /(\.jpg|\.Jpg|\.JPG|\.jpeg|\.Jpeg|\.JPEG|\.png|\.Png|\.PNG)$/i.test(
    fileName
  );
}
    ...
    success: function (data) {
      ...
      if (id_pk !== null) {
        ...
        if (
          ...
          document.getElementById("dataserikat").innerHTML =
            "Pada DPD: " + nama_dpd + " | Pada DPC: " + nama_dpc;
