...
$(document).ready(function () {
    $.ajax({
        type: "GET",
        url: url_endpoint + "get_data_sub_activities_report_byid?id_subac_report=" + localStorage.id_subac_report,
        crossDomain: true,
        cache: false,
...
function edit_location_report() {
    $.ajax({
        type: "GET",
        url: url_endpoint + "get_data_location_sub_activities_report?id_subac_report=" + localStorage.id_subac_report,
        crossDomain: true,
        cache: false,
        success: function (data) {
            var html = '';
            ...
            $.each(data.data_location, function(index, value) {
                ...
                html += '<option value="'+value.city_id+'">'+type+value.name+'</option>';
            });
